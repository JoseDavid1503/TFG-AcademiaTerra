...
class DB
{
     ...
     * @return array|false Devuelve un array con los resultados o false si falla
     */
     ...
     * @param  string $table
     * @param  array $filtro
     * @param  string $orden_campo
     * @param  string $orden_dir
     * @param  int $pagina
     * @param  int $items_por_pagina
     * @return array|false Array con 'total' y 'datos', o false si falla
     */
