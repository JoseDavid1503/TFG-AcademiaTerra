...
<head>
  ...
  <title>DAW - Asignaturas — ACADEMIA TERRA</title>
  ...
  <main class="container mx-auto px-4">
    ...
    <section style="margin-bottom: 60px;">
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <h1 style="font-size: 3rem; margin-bottom: 10px; color: white;">DAW</h1>
            <p class="muted" style="font-size: 1.25rem;">Desarrollo de Aplicaciones Web</p>
        </div>
        ...
        <table class="course-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>5h</td>
                    <td>Conceptos básicos de hardware, redes y sistemas operativos.</td>
                </tr>
                <tr>
                    <td>Bases de Datos</td>
                    <td>6h</td>
                    <td>Diseño, creación y gestión de bases de datos relacionales (SQL).</td>
                </tr>
                <tr>
                    <td>Programación</td>
                    <td>8h</td>
                    <td>Lógica de programación, algoritmos y POO (generalmente con Java).</td>
                </tr>
                <tr>
                    <td>Lenguajes de Marcas y Sist. Gestores de Info.</td>
                    <td>4h</td>
                    <td>Estructuración de información y diseño web estático (HTML y CSS).</td>
                </tr>
                <tr>
                    <td>Entornos de Desarrollo</td>
                    <td>3h</td>
                    <td>Herramientas para programadores: IDEs, control de versiones (Git), testing.</td>
                </tr>
                <tr>
        ...
        <table class="course-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>6h</td>
                    <td>Programación Frontend dinámica e interactiva utilizando JavaScript.</td>
                </tr>
                <tr>
                    <td>Desarrollo Web en Entorno Servidor</td>
                    <td>8h</td>
                    <td>Programación Backend y conexión a BBDD (generalmente PHP o Node.js).</td>
                </tr>
                <tr>
                    <td>Despliegue de Aplicaciones Web</td>
                    <td>3h</td>
                    <td>Configuración de servidores web, hosting, dominios y control de versiones.</td>
                </tr>
                <tr>
                    <td>Diseño de Interfaces Web</td>
                    <td>6h</td>
                    <td>UI/UX, diseño responsive, accesibilidad y frameworks CSS (Bootstrap, Tailwind).</td>
                </tr>
                <tr>
                    <td>Empresa e Iniciativa Emprendedora (EIE)</td>
                    <td>4h</td>
                    <td>Creación y gestión básica de una pequeña empresa tecnológica.</td>
                </tr>
            </tbody>
        </table>
             ...
             <div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap;">
                ...
                <?php if ($ya_matriculado): ?>
                    <button type="button" onclick="abrirModalAvisoMatricula()" class="btn btn-primary" style="padding: 16px 40px; font-size: 1.15rem;">
                        Matricularse en 1º DAW
                    </button>
                    <button type="button" onclick="abrirModalAvisoMatricula()" class="btn btn-primary" style="padding: 16px 40px; font-size: 1.15rem;">
                        Matricularse en 2º DAW
                    </button>
                <?php else: ?>
                    <a href="procesar_matricula.php?curso=DAW_1" class="btn btn-primary" style="padding: 16px 40px; font-size: 1.15rem; display: inline-block; text-decoration: none;">
                        Matricularse en 1º DAW
                    </a>
                    <a href="procesar_matricula.php?curso=DAW_2" class="btn btn-primary" style="padding: 16px 40px; font-size: 1.15rem; display: inline-block; text-decoration: none;">
                        Matricularse en 2º DAW
                    </a>
                <?php endif; ?>
